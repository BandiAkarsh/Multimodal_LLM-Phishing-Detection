...
def _load_tld_set() -> Set[str]:
    ...
    tld_file = os.path.join(
        os.path.dirname(os.path.dirname(__file__)), "01_data", "external", "tld_list.json"
    )
...
class ToolkitSignatureDetector:
    ...
    @classmethod
    def detect_toolkit(
        cls, url: str, html: str, headers: Dict[str, str] = None, soup: BeautifulSoup = None
    ) -> Dict[str, Any]:
        """
        ...
        kingphisher_score, kingphisher_sigs = cls._check_king_phisher(
            url, html, headers, query_params
        )
    ...
    @classmethod
    def _check_gophish(
        cls, url: str, html: str, headers: Dict, query_params: Dict, soup: BeautifulSoup
    ) -> tuple:
    ...
    @classmethod
    def _check_king_phisher(cls, url: str, html: str, headers: Dict, query_params: Dict) -> tuple:
    ...
    async def scrape_url(self, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            result["toolkit_signatures"] = ToolkitSignatureDetector.detect_toolkit(
                url=url, html=result["html"], headers=response_headers, soup=soup
            )
