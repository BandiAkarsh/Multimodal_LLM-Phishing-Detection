...
class ToolkitSignatures(BaseModel):
    ...
    signatures_found: List[str] = Field(
        default_factory=list, description="List of signatures found"
    )
...
class ConnectivityResponse(BaseModel):
    ...
    available_categories: List[str] = Field(
        default_factory=list, description="Classification categories available in current mode"
    )
...
class EmailScanResponse(BaseModel):
    ...
    urls_analyzed: List[URLAnalysisResponse] = Field(
